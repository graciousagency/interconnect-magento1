...
class Gracious_Interconnect_Http_Request_Data_Customer_Factory extends Gracious_Interconnect_Http_Request_Data_FactoryAbstract
{
    ...
    public function setupData(Mage_Customer_Model_Customer $customer) {
        ...
        /* @var  $customerReflector Gracious_Interconnect_Reflection_CustomerReflector */ $customerReflector = new Gracious_Interconnect_Reflection_CustomerReflector();
        $customerEmail = $customer->getEmail();
        $historicInfo = $customerReflector->getCustomerHistoricInfoByCustomerEmail($customerEmail);
    ...
    protected function isCustomerSubscribedToNewsletter($email) {
        /* @var $utilitySubscriber Mage_Newsletter_Model_Subscriber */ $utilitySubscriber = Mage::getModel('newsletter/subscriber');
